    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <h1 class="h3 mb-2 text-gray-800">Πίνακας τμημάτων</h1>

                <p class="mb-4">Πληροφορίες σχετικά με τα τμήματα...
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-danger">
                                                <g:link class="button  text-white" id="${it.id}" controller="department"
