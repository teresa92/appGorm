    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <p class="mb-4">Μπορείτε να εισάγετε έναν νέο εργαζόμενο...
                            ...
                            <form>
                                <div class="form-group">
                                    ...
                                    <input name="employeeLastName" type="text" class="form-control"
                                           ...
                                           aria-describedby="emailHelp" placeholder="Εισάγετε επώνυμο">
                                    <label for="exampleInputEmail1">Επώνυμο</label>

                                    <input name="employeeFirstName" type="text" class="form-control"
                                           id="exampleInputEmail1"
                                           aria-describedby="emailHelp" placeholder="Εισάγετε όνομα">
                                    <label for="exampleInputEmail1">Ημερομηνία</label>

                                    <input name="employeeDateOfBirth" type="date" class="form-control"
                                           id="exampleInputEmail1"
                                           aria-describedby="emailHelp" placeholder="Εισάγετε ημερομηνία">
                                    <br>
                                    <select name="department" class="form-select" aria-label="Default select example">
                                        <option selected>τμήματα</option>
                                        <g:each in="${department}">
                                            <option value="${it.id}">${it.name}</option>
                                        </g:each>
                                    </select>
                                </div>
                                <g:actionSubmit value="Εισαγωγή " controller="employee" action="create"
